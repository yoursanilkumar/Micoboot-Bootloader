...
static const tFlashSector flashLayout[] =
{
  ...
  /* { 0x08004000, 0x04000,  1},           flash sector  1 - Need to reserved for Emulated EEPROM   */
  //{ 0x08008000, 0x04000,  2},          /* flash sector  2 -  Need to reserved for Emulated EEPROM  */
  { 0x0800C000, 0x04000,  3},           /* flash sector  3 -  16Kb User Flash  */
#if (BOOT_NVM_SIZE_KB > 64)
  { 0x08010000, 0x10000,  4},           /* flash sector  4 -  64Kb User Flash */
#endif
#if (BOOT_NVM_SIZE_KB > 128)
  { 0x08020000, 0x20000,  5},           /* flash sector  5 - 128kb User Flash */
#endif
